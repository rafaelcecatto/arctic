...
<html>
  <head> 
    ...
    <title>Arctic - Sistema de Gestão | <?php echo $this->renderSection('titulo'); ?> </title>
    ...
    <!-- Tweaks for older IEs--><!--[if lt IE 9]>
        ...
        <!-- Espaço para renderizar os stilos de cada View -->
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        </ul><span class="heading">Administrativo</span>
        <ul class="list-unstyled">
